...
/**
 * @file ModifiedSecondDerivative.hpp
...
namespace shammodels::basegodunov::modules {
    ...
    class ModifiedSecondDerivative {
        public:
        ...
        ModifiedSecondDerivative(ShamrockCtx &context, Config &solver_config, Storage &storage)
            : context(context), solver_config(solver_config), storage(storage) {}

        void compute_modified_second_derivative();
