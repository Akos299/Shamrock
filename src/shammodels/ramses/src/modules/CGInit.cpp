                ...
                [&](u64 id, const OrientedAMRGraph &oriented_cell_graph) {
                    ...
                    sham::kernel_call(
                        ...
                        [block_size, fourPiG, mean_rho](
                            ...
                            // logger::raw_ln("rho_id ", rho[cell_global_id]);
                            // logger::raw_ln("4PIG", fourPiG);
                            // logger::raw_ln("Aphi", Aphi);

                            // logger::raw_ln("phi_res_init ",res);
                            // logger::raw_ln("phi ", phi[cell_global_id]);
                        });
                });
        }
    };
