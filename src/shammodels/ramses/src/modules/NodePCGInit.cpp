    ...
    class _Kernel {
        ...
        inline static void kernel(Edges &edges, u32 block_size, Tscal fourPiG) {
            edges.cell_neigh_graph.graph.for_each([&](u64 id,
                                                      const CellGraphEdge &oriented_cell_graph) {
                ...
                sham::kernel_call(
                    ...
                    sham::MultiRef{
                        ...
                        graph_neigh_zp,
                        graph_neigh_zm},
                    sham::MultiRef{phi_res_span, phi_z_span, phi_p_span, rhs_span},
                    cell_count,
                    [block_size, fourPiG, mean_rho](
                        ...
                        auto jac_weight = shammodels::basegodunov::JacobiWeight<Tscal>{Tscal(0.0)};
                        ...
                        auto pres               = res * 1. / jac_weight.value;
                        phi_res[cell_global_id] = res;
                        phi_z[cell_global_id]   = pres;
