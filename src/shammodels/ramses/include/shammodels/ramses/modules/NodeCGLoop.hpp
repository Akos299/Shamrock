...
namespace shammodels::basegodunov::modules {
    ...
    class NodeCGLoop : public shamrock::solvergraph::INode {
        ...
        inline void set_edges(
            ...
            // // set node1 edges [il faut utiliser que les cellules de la zone active pour avoir
            // les mêmes résultats]
            ...
            // // set node7 edges [utiliser res_copy au lieu de res pour être sur d'avoir que les
            // donnée de la zone active]
