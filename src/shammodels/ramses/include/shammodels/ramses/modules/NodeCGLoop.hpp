...
namespace shammodels::basegodunov::modules {
    ...
    class NodeCGLoop : public shamrock::solvergraph::INode {
        ...
        // dotProd node
        modules::NodeCGMatVecProd<Tvec, TgridVec> node2{block_size};
        // hadamardProd node
        modules::NodeCGHadamardProd<Tscal> node3{block_size};
        // A-norm node
        modules::NodeCGEnergyNormOfP<Tscal> node4{};
        // New-phi node
        modules::NodeComputeNewPhi<Tscal> node5{block_size};
        // New-residual node
        modules::NodeComputeNewResidual<Tscal> node6{block_size};
        // ddot node new
        ...
        struct Edges {
            ...
            shamrock::solvergraph::IFieldSpan<Tscal> &spans_phi;
